                            ...
                            <form onSubmit={this.handleSubmit}>
                                <div className="form-row row">
                                    <div className="form-group col-md-6">
                                        ...
                                        <input type="text" className="form-control" onChange={this.handleChange} id="username" placeholder="Username" required />
                                        <small id="UsernameError" className="form-text text-muted text-red">
                                        </small>
                                    </div>
                                    <div className="form-group col-md-6">
                                        <label for="email">Email</label>
                                        <input type="email" className="form-control" onChange={this.handleChange} id="email" placeholder="Email" required />
                                ...
                                <div className="form-group">
                                    ...
                                    Your password must be more than 10 characters long, contain an Uppercase letters, a Lowercase letter and a number, and a special character [! @ # $ % ^ & *].
                                    </small>
                                    <small id="passwordError" className="form-text text-muted text-red"></small>
                                </div>
                                <div className="form-group">
                                    <label for="password-cnf">Confirm Password</label>
                                        <input type="password" onChange={this.handleChange} id="cnfpass" name="cnfpass" className="form-control" aria-describedby="passwordHelpBlock" required />
                                        <small id="pass-missmatch" className="form-text text-muted text-red">
                                            
                                        </small>
                                </div>
                                <br />
                                <button type="submit" id="submit" onClick={this.handleSubmit} className="btn btn-primary">Sign Up</button>
                            </form>
                        <hr />
